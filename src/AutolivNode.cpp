...
AutolivNode::AutolivNode(ros::NodeHandle &node, ros::NodeHandle &priv_nh){
    ...
    msg_timer = node.createTimer(ros::Duration(0.1), &AutolivNode::publishMessageShortLongMode);
...
void static AutolivNode::publishMessageShortLongMode(const ros::TimerEvent& e){
